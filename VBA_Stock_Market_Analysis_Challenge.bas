...
Dim ws As Worksheet
    ...
    'Using loops to provide unique values to a column
    ...
    ' List Yearly Change by totaling the total closing costs - total of opening costs
        ...
        For i = 2 To lastrow
            If ws.Cells(i + 1, 1).Value <> ws.Cells(i, 1).Value Then
                ...
                Yearly_Change = Closing - Opening
                    ...
                    End If
             'The percentage change from the total closing price - total opening price
